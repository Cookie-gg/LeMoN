...
export type ChangeArticleMutation = {
  __typename?: 'Mutation';
  changeArticle: { __typename?: 'ArticleObject'; id: string };
};
...
export type DeleteArticleMutation = {
  __typename?: 'Mutation';
  deleteArticle: { __typename?: 'ArticleObject'; id: string };
};
...
export type FindAllArticlesQuery = {
  ...
  articles: Array<{
    ...
    markdown: string;
    html: string;
    topicIcons: Array<{ __typename?: 'TopicObject'; displayName: string; icon: string }>;
    typeIcon: { __typename?: 'TopicObject'; displayName: string; icon: string };
    relations: Array<{
      __typename?: 'ArticleObject';
      articleId: string;
      published: boolean;
      ...
      emoji: string;
      type: string;
      topicIcons: Array<{ __typename?: 'TopicObject'; displayName: string }>;
    }>;
  }>;
};
...
export type FindMoreArticlesQuery = {
  __typename?: 'Query';
  articles: Array<{
    __typename?: 'ArticleObject';
    articleId: string;
...
export type FindArticleQuery = {
  ...
  article: {
    ...
    markdown: string;
    html: string;
    allTopics: Array<{ __typename?: 'TopicObject'; displayName: string; name: string }>;
  };
};
...
export type FindAllOnlyTopicsQuery = {
  __typename?: 'Query';
  topics: Array<{ __typename?: 'TopicObject'; displayName: string; name: string }>;
};
 ...
 * });
 */
export function useChangeArticleMutation(
  baseOptions?: Apollo.MutationHookOptions<ChangeArticleMutation, ChangeArticleMutationVariables>,
) {
...
export type ChangeArticleMutationOptions = Apollo.BaseMutationOptions<
  ChangeArticleMutation,
  ChangeArticleMutationVariables
>;
 ...
 * });
 */
export function useFindAllArticlesQuery(
  baseOptions?: Apollo.QueryHookOptions<FindAllArticlesQuery, FindAllArticlesQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<FindAllArticlesQuery, FindAllArticlesQueryVariables>(FindAllArticlesDocument, options);
}
export function useFindAllArticlesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<FindAllArticlesQuery, FindAllArticlesQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
 ...
 * });
 */
export function useFindMoreArticlesQuery(
  baseOptions: Apollo.QueryHookOptions<FindMoreArticlesQuery, FindMoreArticlesQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<FindMoreArticlesQuery, FindMoreArticlesQueryVariables>(FindMoreArticlesDocument, options);
}
export function useFindMoreArticlesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<FindMoreArticlesQuery, FindMoreArticlesQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export function useFindArticleLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<FindArticleQuery, FindArticleQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
 ...
 * });
 */
export function useFindAllTopicsQuery(
  baseOptions?: Apollo.QueryHookOptions<FindAllTopicsQuery, FindAllTopicsQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<FindAllTopicsQuery, FindAllTopicsQueryVariables>(FindAllTopicsDocument, options);
}
export function useFindAllTopicsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<FindAllTopicsQuery, FindAllTopicsQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
 ...
 * });
 */
export function useFindAllOnlyTopicsQuery(
  baseOptions?: Apollo.QueryHookOptions<FindAllOnlyTopicsQuery, FindAllOnlyTopicsQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<FindAllOnlyTopicsQuery, FindAllOnlyTopicsQueryVariables>(FindAllOnlyTopicsDocument, options);
}
export function useFindAllOnlyTopicsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<FindAllOnlyTopicsQuery, FindAllOnlyTopicsQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<FindAllOnlyTopicsQuery, FindAllOnlyTopicsQueryVariables>(
    FindAllOnlyTopicsDocument,
    options,
  );
}
